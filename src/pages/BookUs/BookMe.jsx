      ...
      <section className={styles.form_strip}>
        <div className={`${styles.container} ${styles.form_wrap}`}>
          {sent && (
            ...
            >
              🎉 Thanks! We’ll confirm availability shortly.
            </div>
          )}
          ...
          <form className={styles.form} onSubmit={handleSubmit} noValidate>
            ...
            <div className={styles.field}>
              ...
              <input
                ...
                name="menu"
                type="text"
                placeholder="Dishes, cuisine, dietary, etc."
              />
            </div>
            ...
            <div className={styles.field}>
              ...
              <input
                ...
                name="services"
                type="text"
                placeholder="Decor, rentals, bar, staff…"
              />
            </div>
        ...
        <div className={`${styles.container} ${styles.band_grid}`}>
          <div className={styles.brand_side}>
            {logo ? (
              ...
              <div className={styles.brand_placeholder}>Logo</div>
            )}
          ...
          <div className={styles.contact_side}>
            ...
            <div className={styles.contact_list}>
              ...
              <a href="mailto:hello@yourcatering.com">
                ✉️ hello@yourcatering.com
              </a>
              <a
